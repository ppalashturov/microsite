...
<body>
	...
	<h2 class="span12">Промени Главна страница</h2>
	...
	<div id="main-table-box span12">
		...
		<form action="<?php echo base_url(); ?>admin2/homeedit" method="post" id="crudForm" class="form-div span12" autocomplete="off" enctype="multipart/form-data" accept-charset="utf-8">				<div class="form-field-box" id="home_title_field_box">
					<div class="form-display-as-box" id="home_title_display_as_box">
						Заглавие :
					</div>
					<div class="form-input-box" id="home_title_input_box">
						<input id='field-home_title' name='home_title' type='text' value="<?php echo $title; ?>" maxlength='150' />					</div>
					<div class="clear"></div>
				</div>
					...
					<div class="form-input-box" id="home_content_input_box">
						<textarea id='field-home_content' name='home_content' class='texteditor' ><p>
							<?php echo $content;?>
						</textarea>					
					</div>
					<div class="clear"></div>
					...
					<div class="form-input-box" id="home_meta_title_input_box">
						<input id='field-home_meta_title' name='home_meta_title' type='text' value="<?php echo $meta_title ;?>" maxlength='60' />					</div>
					<div class="clear"></div>
				</div>
					...
					<div class="form-input-box" id="home_meta_keywords_input_box">
						<input id='field-home_meta_keywords' name='home_meta_keywords' type='text' value="<?php echo $meta_keywords ;?>" maxlength='250' />					</div>
					<div class="clear"></div>
				</div>
					...
					<div class="form-input-box" id="home_meta_description_input_box">
						<input id='field-home_meta_description' name='home_meta_description' type='text' value="<?php echo $meta_description;?>" maxlength='180' />					</div>
					<div class="clear"></div>
				</div>
							<br /><br />
