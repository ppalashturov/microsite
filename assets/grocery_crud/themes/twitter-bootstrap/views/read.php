...
<div class="twitter-bootstrap crud-form">
	...
	<h2 class="span12"><?php echo "Преглед"; ?> <?php echo $subject?></h2>
	...
	<div id="main-table-box span12">
		...
		echo form_open( $update_url, 'method="post" id="crudForm" class="form-div span12" autocomplete="off" enctype="multipart/form-data"');
			foreach($fields as $field){ ?>
				<div style="float: left;display: block;width: 100%;" class="form-field-box" id="<?php echo $field->field_name; ?>_field_box">
					<div style="float: left;width: 20%;min-height: 100px;" class="form-display-as-box" id="<?php echo $field->field_name; ?>_display_as_box">
						<?php echo $input_fields[$field->field_name]->display_as?><?php echo ($input_fields[$field->field_name]->required)? '<span class="required">*</span>' : ""?> :
					</div>
					
					<div style="float: left;width: 80%;min-height: 50px;" class="form-input-box" id="<?php echo $field->field_name; ?>_input_box">
			...
			<?php 	if(!$this->unset_back_to_list) { ?>
				<br />
				<br />
				<input style="float: left; type="button" onClick="window.history.back()" value="Назад" class="btn btn-large return-to-list" />
			<?php 	} ?>
