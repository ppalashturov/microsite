		...
		switch ($real_type) {
			...
			case 'upload_file':
				...
				else
				{
					...
					if($is_image)
					{
						$file_url_anchor .= ' class="image-thumbnail"><img src="' . base_url() . 'assets/resizer.php?w=150&src='.$file_url.'" height="50px">';
					}
					else
					{
...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function get_upload_file_input($field_info, $value)
	{
		...
		$input .= $is_image ? " $image_class'><img src='" . base_url() . "assets/resizer.php?w=150&src=".$file_url."' height='50px'>" : "' target='_blank'>$value";
		$input .= "</a> ";
